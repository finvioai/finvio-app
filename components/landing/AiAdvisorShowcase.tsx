    ...
    <section className="bg-off-white py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-16 md:grid-cols-2">
          <div>
            <span className="font-mono-eyebrow text-brand">AI Advisor</span>
            ...
            <div className="mt-10 space-y-5">
              {[
                ...
                <div key={n} className="flex items-start gap-4">
                  <div className="flex size-7 shrink-0 items-center justify-center rounded-full bg-brand/20 font-mono-eyebrow text-brand">
                    {n}
                  </div>
                  <div>
          ...
          <div className="rounded-3xl bg-navy p-8 shadow-2xl ring-1 ring-navy/5">
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="rounded-2xl rounded-bl-sm bg-background p-4 text-sm text-navy shadow-lg">
                  ...
                  cross $1M in capital, liability increases by{' '}
                  <span className="font-semibold">$450/yr</span>.
                  I&apos;d suggest restructuring secondary holdings to a Wyoming holding company.
                </div>
                <div className="flex gap-2">
                  {['Show analysis', 'Execute move', 'Save scenario'].map((label) => (
                    <button
                      key={label}
                      className="rounded-full border border-navy-foreground/20 bg-navy-foreground/5 px-3 py-1 font-mono-eyebrow text-navy-foreground"
                    >
                      {label}
                    </button>
                  ))}
            ...
            <div className="mt-6 flex h-12 items-center justify-between rounded-xl border border-navy-foreground/15 bg-navy-foreground/5 px-4">
              ...
              <span className="flex items-center gap-2 font-mono-eyebrow text-navy-foreground/60">
                <span className="size-1.5 rounded-full bg-brand" /> Voice ready
              </span>
            </div>
          </div>
        </div>
