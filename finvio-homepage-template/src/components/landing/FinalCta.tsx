    ...
    <section className="bg-background py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="bg-brand-gradient shadow-brand-glow relative isolate overflow-hidden rounded-3xl px-10 py-20 text-center text-navy-foreground md:px-20">
          <div className="absolute inset-0 -z-0 opacity-30" style={{ background: "radial-gradient(50% 60% at 20% 0%, oklch(0.85 0.12 250 / 0.5) 0%, transparent 70%), radial-gradient(40% 50% at 90% 100%, oklch(0.6 0.19 258 / 0.6) 0%, transparent 70%)" }} />
